...
from worker.app.jobs.execute_tests import build_executor_request, detect_execution_plan, execute_tests_job
    ...
    class FakeExecutorClient:
        ...
        def execute(self, payload: dict):
            ...
            generated_junit.write_text(
                '<testsuite name="pytest" tests="1" failures="1" errors="0" skipped="0"></testsuite>',
                encoding="utf-8",
            )
...
def test_execute_tests_job_marks_stage_failed_and_uploads_results_on_environment_setup_failure(
    ...
    class FakeExecutorClient:
        ...
        def execute(self, payload: dict):
            return SimpleNamespace(
                python_version="Python 3.12.9",
                isolation={"network_mode": "none", "worker_has_docker_socket": False},
                steps={
                    "bootstrap": [],
                    "install": [
                        {
